...
data class TaxcomProcessStatusResponse(
    val status: String,
    val running: Boolean,
    ...
    val processedOutlets: Long = 0,
    val processedKkt: Long = 0,
    val processedShifts: Long = 0,
    val processedReceipts: Long = 0,
...
data class TaxcomExportStatusResponse(
    ...
    val lastError: String?,
    val discovery: TaxcomProcessStatusResponse? = null,
    val receipts: TaxcomProcessStatusResponse? = null,
) {
    companion object {
